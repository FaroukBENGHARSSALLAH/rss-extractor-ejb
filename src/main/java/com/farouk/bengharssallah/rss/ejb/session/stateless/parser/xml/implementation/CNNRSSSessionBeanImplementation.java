...
import com.farouk.bengharssallah.rss.ejb.session.stateless.parser.xml.CNNRSSSessionBean;
...
@Stateless(name="CNNRSSEjb")
public class CNNRSSSessionBeanImplementation implements CNNRSSSessionBean {
